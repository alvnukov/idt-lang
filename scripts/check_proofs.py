...
ALLOWED_EXACT_COMMANDS = {
    ...
    ("lake", "build", "Proofs.QMClosure.CGSCTypedSemanticExtensions"),
    ("lake", "build", "Proofs.QMClosure.CGSCTypedDecorativeWall"),
    ...
    ("lake", "build", "Proofs.QMClosure.UniversalPrimitiveToyWall"),
    ("lake", "build", "Proofs.QMClosure.PrimitiveGeneratedSourceKernel"),
    ...
    ("lake", "build", "Proofs.QMClosure.CGSCStructuralTargetKernel"),
